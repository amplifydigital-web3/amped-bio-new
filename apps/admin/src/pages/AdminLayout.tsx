...
import { AdminNotificationContainer } from "../components";
...
export function AdminLayout() {
  ...
  const sidebarItems = [
    { id: "dashboard", icon: BarChart3, label: "Dashboard", path: "/", shortcut: "⌘⌥D" },
    { id: "users", icon: Users, label: "Users", path: "/users", shortcut: "⌘⌥U" },
    { id: "blocks", icon: Layers, label: "Blocks", path: "/blocks", shortcut: "⌘⌥B" },
    { id: "themes", icon: Hexagon, label: "Themes", path: "/themes", shortcut: "⌘⌥T" },
    { id: "files", icon: Files, label: "Files", path: "/files", shortcut: "⌘⌥F" },
    { id: "pools", icon: CoinsIcon, label: "Pools", path: "/pools", shortcut: "⌘⌥P" },
    {
      id: "ndau-conversions",
      icon: ArrowRightLeft,
