...
export const bannerSchema = z.object({
  ...
  panel: z.enum(["home", "profile", "reward", "gallery", "blocks", "rewardPools", "createRewardPool", "leaderboard", "rns", "wallet", "pay", "account"]).optional(), // Optional panel to redirect to
});
