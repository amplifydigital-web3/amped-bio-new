...
// The base URL for email links. For auth emails, this should be the
// client app URL where the user will actually consume the link.
...
export const sendEmailVerification = async (email: string, token: string) => {
  ...
  // The verify-email endpoint is handled by the client app (where the user is redirected)
