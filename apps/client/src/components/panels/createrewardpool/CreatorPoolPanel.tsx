...
import { BarChart3, TrendingUp, Users, Gift, Coins, Target, Calendar, Clock, Trophy, Plus, Minus, Upload, Percent, Info, X, Check, Save, Sparkles, Star, Crown, Zap, type LucideIcon } from 'lucide-react';
...
export function RewardPoolPage() {
  ...
  const addPerkToTier = (tierId: string) => {
    setStakingTiers(tiers =>
      tiers.map(tier =>
        tier.id === tierId 
          ? { ...tier, perks: [...tier.perks, 'New perk'] }
          : tier
      )
    );
  };
    ...
    setStakingTiers(tiers =>
      tiers.map(tier =>
        tier.id === tierId
          ? {
              ...tier,
              perks: tier.perks.map((perk, index) =>
      ...
      <div className="max-w-4xl mx-auto px-4 md:px-8 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-gray-900 mb-2">{poolName || 'Your Reward Pool'}</h1>
              <p className="text-gray-600">{poolDescription || 'Pool analytics and fan leaderboard'}</p>
            </div>
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <div className="text-2xl font-bold text-blue-900">
                  {showUSD ? `$${(125420 * 0.25).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}` : '125,420 REVO'}
                </div>
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <div className="text-2xl font-bold text-green-900">
                  {showUSD ? `$${(8750 * 0.25).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}` : '8,750 REVO'}
                </div>
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <div className="text-2xl font-bold text-purple-900">
                  {showUSD ? `$${(2500 * 0.25).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}` : '2,500 REVO'}
                </div>
          ...
          <div className="p-6 border-b border-gray-200">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm font-medium text-gray-700">{mockLeaderboard.length} Fans</span>
              </div>
            </div>
          </div>
                  ...
                  <tr key={fan.rank} className="hover:bg-gray-50 transition-colors duration-200">
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center space-x-2">
                        <span className={`w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold ${
                          ...
                          fan.rank === 2 ? 'bg-gray-100 text-gray-700' :
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <div className="flex items-center space-x-2">
                            <span className="text-sm font-medium text-gray-900">{fan.username}</span>
                            {fan.isVerified && (
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span className={`inline-flex items-center space-x-1 px-2 py-1 rounded-full text-xs font-medium ${getTierColor(fan.tier)}`}>
  ...
  return (
    <>
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600">Set up a reward pool to engage your community and earn from their stakes</p>
      </div>
              ...
              return (
                <div key={tier.id} className="border border-gray-200 rounded-lg p-4">
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex items-center space-x-3">
                      <div className={`p-2 rounded-lg ${tier.color.replace('text-', 'bg-').replace('-700', '-100')}`}>
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="flex items-center space-x-4 p-4 bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl border border-blue-200">
                ...
                <div className="flex-1">
                  <h3 className="text-xl font-bold text-gray-900 mb-1">{poolName || 'Unnamed Pool'}</h3>
                  <p className="text-sm text-gray-600 mb-2">{poolDescription || 'No description provided'}</p>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-blue-800">
                      Once launched, your pool will be live and users can start staking. 
                      You can modify tiers and perks later, but the initial stake and creator fee cannot be changed.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <>
                ...
                <div className="p-6 text-center">
                  ...
                  <div className="bg-green-50 rounded-lg p-4 mb-4 border border-green-200">
                    <div className="text-sm text-green-700 mb-2 font-medium">Pool Created Successfully</div>
