...
import { Plus, List, Image as ImageIcon, AlertCircle } from "lucide-react";
    ...
    try {
      ...
      if (selectedImageFile) {
        try {
          ...
          setImageUploadError(`Category created but image upload failed: ${imageError.message}`);
          setSuccess("Category created successfully, but image upload failed.");
        }
      } else {
  ...
  return (
    <div className="h-screen max-h-screen flex flex-col bg-gray-50">
      ...
      <div className="flex-1 overflow-hidden">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg border border-gray-200 shadow-sm">
              <div className="p-6 border-b border-gray-100">
                ...
                <p className="text-gray-600 mt-1">Create and organize theme categories</p>
              </div>
        ...
        {(error || imageUploadError || success) && (
          <div className="space-y-3">
            ...
            {imageUploadError && (
              <div className="p-4 bg-red-50 border border-red-200 rounded-lg flex items-start gap-3">
                <AlertCircle className="h-5 w-5 text-red-500 mt-0.5 flex-shrink-0" />
                <div>
                  <p className="text-red-700 text-sm font-medium">Image Upload Error</p>
