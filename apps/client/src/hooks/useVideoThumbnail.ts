...
export function useVideoThumbnail(
  defaultOptions: UseVideoThumbnailOptions = {}
  ...
  const generateThumbnail = useCallback(
    async (videoFile: File, options?: ThumbnailOptions): Promise<ThumbnailResult | null> => {
  ...
  const generateThumbnailFromUrl = useCallback(
    async (videoUrl: string, options?: ThumbnailOptions): Promise<ThumbnailResult | null> => {
      setIsGenerating(true);
      setError(null);
