      ...
      <div className="w-full max-w-md p-8 space-y-4 bg-white rounded-xl shadow-md">
        ...
        {status === 'form' && (
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            <p className="text-center text-gray-600">Enter your email address to receive a verification link:</p>
        ...
        {status === 'success' && (
          <div className="text-center space-y-4">
            ...
            <p className="text-gray-600">We've sent a verification email to <strong>{emailParam}</strong>.</p>
        ...
        {status === 'error' && (
          <div className="space-y-4">
            <div className="text-center">
              ...
              <p className="text-gray-600 mt-1">{message || 'There was a problem sending the verification email.'}</p>
              <p className="text-gray-600">Please make sure the email address is correct and try again.</p>
            </div>
