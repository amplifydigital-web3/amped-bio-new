...
const modernCollection: Collection = {
  ...
  name: "Modern & Minimal",
  description:
    "Clean, contemporary designs with a focus on simplicity and elegance. Perfect for personal branding and professional portfolios.",
  collaborator: {
    name: "Alex Design",
...
const natureCollection: Collection = {
  ...
  name: "Nature & Organic",
  description:
    "Inspired by the natural world, featuring organic textures, earthy colors, and flowing animations.",
  collaborator: {
    name: "Emma Nature",
...
const cyberpunkCollection: Collection = {
  ...
  description:
    "Bold, neon-infused designs that push the boundaries of digital aesthetics. For the forward-thinking creator.",
  collaborator: {
    name: "Neo Digital",
...
const oceanCollection: Collection = {
  ...
  name: "Ocean & Coastal",
  description:
    "Serene and calming designs inspired by the sea, featuring fluid animations and coastal color palettes.",
  collaborator: {
    name: "Marina Waves",
...
const redBullCollection: Collection = {
  ...
  description:
    "High-energy themes inspired by motorsports and extreme athletics. Perfect for sports and energy-driven brands.",
  collaborator: {
...
const chanelCollection: Collection = {
  ...
  name: "Chanel Luxe",
  description:
    "Timeless and elegant themes inspired by haute couture. Perfect for luxury brands and sophisticated personal brands.",
  collaborator: {
    name: "Chanel Digital",
