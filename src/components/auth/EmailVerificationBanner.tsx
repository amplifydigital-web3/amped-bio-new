...
const EmailVerificationBanner = () => {
    ...
    const handleResendEmail = () => {
        ...
        return resendEmailVerification(authUser.email)
            .then(() => {
    ...
    return (
        <div className="w-full bg-amber-50 border-l-4 border-amber-400 p-4 mb-6 rounded shadow-sm">
            <div className="flex items-start">
                ...
                <div className="ml-3 flex-1">
                    <div className="flex justify-between items-center">
                        <h3 className="text-sm font-medium text-amber-800">Verify your email address</h3>
                    ...
                    <div className="mt-3">
                        ...
                        >
                            {isResending ? (
                                <>
                                    <svg className="animate-spin -ml-0.5 mr-2 h-3 w-3 text-amber-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
