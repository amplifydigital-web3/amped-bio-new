  ...
  ({ label, leftText, pattern, error, ...props }, ref) => {
    return (
      <div className="space-y-1">
        ...
        {leftText && (
          <div className={`flex overflow-hidden focus-within:ring-2 focus-within:ring-blue-500 focus-within:border-blue-500 focus-within:rounded-md ${error ? 'border-red-500' : ''}`}>
