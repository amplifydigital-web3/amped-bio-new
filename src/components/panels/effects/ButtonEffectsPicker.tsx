...
const buttonEffects = [
  ...
  { id: 1, name: "Scale", preview: "hover:scale-105 transition-transform" },
  {
    id: 2,
    name: "Glow",
    preview: "hover:shadow-[0_0_15px_rgba(59,130,246,0.5)] transition-shadow",
  },
  ...
  { id: 8, name: "Pop", preview: "hover:scale-110 active:scale-95 transition-transform" },
  {
    ...
    name: "Shine",
    preview:
      "hover:before:opacity-100 before:absolute before:inset-0 before:bg-gradient-to-r before:from-transparent before:via-white/20 before:to-transparent before:opacity-0 before:transition-opacity overflow-hidden relative",
  },
];
...
export function ButtonEffectsPicker({ value, onChange }: ButtonEffectsPickerProps) {
  return (
    <div className="space-y-4">
      <label className="block text-sm font-medium text-gray-700">Button Hover Effects</label>
