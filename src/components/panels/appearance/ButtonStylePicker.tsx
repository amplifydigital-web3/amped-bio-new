...
const buttonStyles = [
  ...
  },
  {
    id: 7,
    name: "Floating",
    preview: "rounded-lg bg-gray-100 hover:-translate-y-1 transition-transform shadow-md",
  },
  {
    id: 8,
    name: "Bordered Glow",
...
export function ButtonStylePicker({
  ...
  return (
    <CollapsiblePanelWrapper title="Button Style">
      ...
      <div className="mt-3">
        <ColorPicker label="Button Color" value={color} onChange={onButtonColorChange} />
      </div>
